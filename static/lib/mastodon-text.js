...
//'(\@[a-zA-Z0-9\.][a-zA-Z0-9_\-]{0,24})?', // $3: instance name
//'(?:\@.+\@.+|@.+)',
...
var serviceUri = "https://gplusdon.azurewebsites.net/";
//var serviceUri = "https://twitter.com/";

var autoLinkEntities = function (text, entities, options) {
  var options = clone(options || {});
  options.hashtagClass = options.hashtagClass || DEFAULT_HASHTAG_CLASS;
  options.hashtagUrlBase = options.hashtagUrlBase || serviceUri + 'search?q=%23';
  options.cashtagClass = options.cashtagClass || DEFAULT_CASHTAG_CLASS;
  options.cashtagUrlBase = options.cashtagUrlBase || serviceUri + 'search?q=%24';
  options.listClass = options.listClass || DEFAULT_LIST_CLASS;
  options.usernameClass = options.usernameClass || DEFAULT_USERNAME_CLASS;
  options.usernameUrlBase = options.usernameUrlBase || serviceUri;
  options.listUrlBase = options.listUrlBase || serviceUri;
...
var version = 1;
var maxWeightedTweetLength = 500; //140;
var scale = 1;
var defaultWeight = 1;
